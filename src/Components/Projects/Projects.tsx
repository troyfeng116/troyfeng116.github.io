...
export const Projects = () => {
	...
	const imgs = [
		[
			'Media/Images/Projects/n-queens-demo.png',
			'/Media/Images/Projects/knights-tour-demo.png'
		],
		['Media/Images/Projects/merge-sort.png'],
		[
			'Media/Images/Projects/multiplication.png',
			'Media/Images/Projects/determinant.png',
			'Media/Images/Projects/rref.png',
			'Media/Images/Projects/inverse.png'
		],
