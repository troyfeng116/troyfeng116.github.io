...
export const projectTitles = ['Chess Backtracking Visualizers', 'Sorting Visualizer', 'Matrix Operations Calculator', 'Project Euler+', 'Daily Coding Problem', 'Personal Website']
