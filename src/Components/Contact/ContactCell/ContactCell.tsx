...
import { Clickable, StandardFonts, StandardLayout, StandardTextColors } from 'Components/Styles'
...
export const ContactCell: React.FC<ContactCellProps> = (props) => {
    ...
    return (
        <ContactAnimation>
            <section className={`${StandardLayout.FlexColCenter} ${Clickable}`} style={{ width: 150, height: 150 }}>
