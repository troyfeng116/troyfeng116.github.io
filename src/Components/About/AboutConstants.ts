...
(web development & algorithmic computation), and quantum physics.
...
and Chinese), or watching sports (I'm a fan of the Boston sports 
...
philosophy, and art history. On campus, I work as a peer tutor in the
Math Department, I volunteer with Code Haven as a classroom mentor,
and I am a problem writer for Yale Math Competition.`,
...
Typescript and Next.js, building substantial web product features from
the ground-up including the company landing page, blog, and survey
infrastructure. My frontend knowledge and skillset also includes data
...
for building to conduct research at the intersection of computer science,
