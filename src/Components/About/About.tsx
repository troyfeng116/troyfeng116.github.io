...
export const About = () => {
    ...
    const textArr = [
        ...
        `I am currently an undergraduate student at Yale University in Pauli Murray College, class of 2024 as I am on a leave of absence after my first year (Class of 2023 at heart). I will hopefully be double majoring in Computer Science & Mathematics (B.S.) and Physics (B.A.), and I am interested in AI and quantum computing. I have also already taken or plan to take coursework in music performance (private lessons and chamber music), Chinese (advanced language and history/culture), philosophy, and art history. On campus, I work as a peer tutor in the Math Department, I volunteer with Code Haven as a classroom mentor, and I am a problem writer for Yale Math Competition.`,
        `I am an experienced React TypeScript web developer with the ability to efficiently build and ship industry-standard code within an inter-departmental team. I am currently a Software Engineer Intern at Eureka Surveys, a market research startup that distributes paid surveys to over 50,000 daily active users. At Eureka, I am a frontend engineer working in React Typescript and Next.js, building substantial web features from the ground-up including the company landing page, blog, and survey infrastructure. I also have substantial experience in competitive mathematics, Java, C/C++, numerical analysis, number theory, and algorithmic computation through coursework at Yale and personal projects.`,
