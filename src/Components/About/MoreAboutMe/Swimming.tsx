...
export const Swimming: React.FC = () => {
    ...
    return (
        <div>
            ...
            <TextGradient className={`${StandardMargin.B12}`} from={textGradientThemeMap[TextGradientColors.Pink]} to={textGradientThemeMap[TextGradientColors.Orange]}>
            ...
            <TextGradient className={`${StandardMargin.B30}`} from={textGradientThemeMap[TextGradientColors.Pink]} to={textGradientThemeMap[TextGradientColors.Orange]}>
                <p className={`${StandardFonts.SmallTextAltBold} ${StandardMargin.Y0}`} style={{ lineHeight: 1.5 }}>
            ...
            <div className={`${StandardLayout.FlexCol}`}>
                <TextGradient from={textGradientThemeMap[TextGradientColors.Pink]} to={textGradientThemeMap[TextGradientColors.Orange]} className={`${StandardWidth.FitContent}`}>
                    <div className={`${StandardLayout.FlexCol}`}>
